#!/usr/bin/env python3
"""Residual zoom for event 0_879_3201 with jacscanomaly feature markers."""
...
DATA = ROOT.parent / "roman_simu/anomaly_finder_result/planet_signal_data/planet_signal_result_1362_3201.json"
...
def main() -> None:
    ...
    # Measure local feature widths with the current jacscanomaly release.
    ...
    fig.savefig(OUTDIR / "0_879_3201_input_pspl_residual_zoom.png", dpi=300, facecolor="white")
    fig.savefig(OUTDIR / "0_879_3201_input_pspl_residual_zoom.pdf", facecolor="white")
    plt.close(fig)
